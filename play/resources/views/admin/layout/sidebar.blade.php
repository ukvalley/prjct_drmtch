    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        <div class="pull-left image">
          <img src="https://www.ukvalley.com/demo/cspl_investment/dist/img/avatar04.png" class="img-circle" alt="User Image">
        </div>
      ...
      <ul class="sidebar-menu" data-widget="tree">
       ...
       <li class="treeview">
         ...
         <li class="treeview">
          <a class="collapsible-header waves-effect waves-cyan"><i class="fa fa-image"></i>Games<span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li>
              <a href="{{url('/')}}/admin/create_game" class="waves-effect waves-cyan"><i class="fa fa-circle-o"></i>Create Game</a>
            </li>
            <li>
               <a href="{{url('/')}}/admin/view_game" class="waves-effect waves-cyan"><i class="fa fa-circle-o"></i>View Game</a>
            </li>
...
<li>
        ...
        <li class="bold"><a href="{{url('/')}}/admin/user_level_income" class="waves-effect waves-cyan"><i class="fa fa-angellist"></i>Referal Payout</a>
           ...
           <li class="bold"><a href="{{url('/')}}/admin/winning_history" class="waves-effect waves-cyan"><i class="fa fa-angellist"></i>Winning History</a>
