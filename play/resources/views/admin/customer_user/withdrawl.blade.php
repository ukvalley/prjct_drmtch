  ...
  <script type="text/javascript">
    $(document).ready(function()
    {
      $("#form").submit(function()
      {
        ...
        {
          $('#error_total_amount').text('Withdrawl Amount Should be greater than min Rs1000 and max Rs200000');
        ...
        { 
          $('#error_total_amount').text('Daily Withdrawl Limit is min Rs500 and max Rs200000');
          return false;
        }
        else 
        {
